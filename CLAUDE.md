...
- `trails/plan-viewer.ts` - Interactive plan viewer. The header's pace preset and hours/day inputs are persisted in `PlanState` and feed both `computeDays` and the Resupply tab's legs — the page fixes neither figure
