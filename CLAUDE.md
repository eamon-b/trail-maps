...
- `guide/[trailId]/plan.tsx` — Day planner over the saved plan: name, start date, day cards with dates and rest days, Stops section (overnight candidates with OSM services strips; a ticked stop expands to nights / note / booked), Suggest stops, resupply legs between the chosen stops (`Choose stops` opens the picker), water carries
