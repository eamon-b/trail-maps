...
export default function PlanScreen() {
  ...
  const extras = useMemo(
    () => computePlanExtras(trail, sectionConfig, effectiveDailyKm),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [trail, sectionConfig.startKm, sectionConfig.endKm, effectiveDailyKm],
  );
      ...
      {!validSection ? (
        ...
        <>
          ...
          <Section title="Resupply">
            <ResupplyCard
              legs={extras.foodCarries}
              hasData={extras.resupply.hasResupplyData}
              units={units}
            />
          </Section>
